...
/**
 * @provider DateLibrary
 * @description A library to transform the date from the models into human readable date
 * @function {(date: string) => string} toHuman - output the date in a friendly format "YYYY MMM, DD"
 * @usage `DateLibrary.toHuman(date)`
 * @import import { DateLibrary } from '@/libraries/date'
 */
